...
async function sendVerificationPanel(channel) {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      '**Welcome to DonutDemand!** To access this server, you need to verify your account.\n\n' +
      ...
      '*If you don\'t trust this link, you can verify manually via a support ticket, but this may take up to 24 hours.*'
    )
